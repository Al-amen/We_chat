...
class APIs {
      ...
      var res = await post(Uri.parse('https://fcm.googleapis.com/fcm/send'),
          headers: {
            ...
            HttpHeaders.authorizationHeader:
                'AAAAc3IZRAw:APA91bFrwkk1iHT4_t0wa5FNDgXKEERachY3lLSnuuksltGHCF9K0_E6xAfqYAB6jlydWga4ABLSrMyiXZzOx7ziNwLrTFHIaT0K5a7A93cm0iprbr5hUF-3TPof1XcjnoB6-qvwAvtj'
          },
  ...
  static Future<void> sendChatImage(ChatUser chatUser, File file) async {
    ...
    //updating image in firestore database
    final imageUrl = await ref.getDownloadURL();
    await sendMessage(chatUser, imageUrl, Type.image); // chage to here
  }
